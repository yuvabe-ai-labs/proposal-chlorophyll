...
const RUNGS: Rung[] = [
  {
    ...
    process: "query → ranked results",
    knowledge: "tagged case library + vector index",
    scope: "in",
    indent: "lg:ml-0",
  },
  {
    ...
    process: "generate → you edit",
    knowledge: "templates, voice guide, exemplars",
    scope: "in",
    indent: "lg:ml-10",
  },
  {
    ...
    process: "chain with checkpoints",
    knowledge: "frameworks as operators; pattern library",
    scope: "partial",
    indent: "lg:ml-20",
  },
  {
    ...
    knowledge: "quality signals; market reality",
    scope: "horizon",
    indent: "lg:ml-30",
  },
  {
    ...
    process: "diverge → debate → converge",
    knowledge: "role archetypes; workshop templates",
    scope: "horizon",
    indent: "lg:ml-40",
  },
  {
    ...
    process: "event-triggered, gated",
    knowledge: "live knowledge; governance-as-data",
    scope: "horizon",
    indent: "lg:ml-50",
  },
];
...
const BLOCKS: { k: string; v: string }[] = [
  { k: "Skill", v: "what it does" },
  { k: "Process", v: "how it flows · human gates" },
  { k: "Knowledge", v: "what it knows" },
];
