  ...
  return (
    <main className="bg-neutral-100">
      <Doc>
        ...
        <PiecesCompare />  {/* s8 — Why Yuvabe: the three-domain matrix */}
        <Engagement />     {/* s9 — How we'd work together */}
        {/* Appendix — platform deep dives */}
        <PieceQuilt />     {/* A1 — Quilt in detail */}
        <PieceKittyKat />  {/* A2 — KittyKat in detail */}
        <Footer />
      </Doc>
      <NavRail />
    </main>
